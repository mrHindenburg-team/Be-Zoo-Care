...
struct ACKWebView_Preview: View {
    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            ACKWebContainerView(url: selectedURL.rawValue)
                .id(id)
        }
...
struct ACKNavigationDebugView: View {
    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            // WebView
            ACKWebView(urlString: "https://google.com", navState: navState)
                .ignoresSafeArea(edges: .bottom)
