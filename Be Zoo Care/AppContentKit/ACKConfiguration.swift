...
public enum ACKATTHandling: Sendable {
    case managedByLibrary
    case managedByHost(signal: ACKATTSignal)
    case skip
}

public final class ACKATTSignal: @unchecked Sendable {
...
public final class ACKSplashSignal: @unchecked Sendable {
...
public final class ACKAppsFlyerSignal: @unchecked Sendable {
...
public typealias ACKSplashProvider    = (_ onComplete: @escaping () -> Void) -> AnyView
public typealias ACKMainViewProvider  = () -> AnyView
public typealias ACKAppsFlyerIDProvider = () -> String?
public typealias ACKExtraInstallFieldsProvider = () -> [String: Any]

public struct ACKConfiguration: @unchecked Sendable {

    public let registerURL:                String
    public let syncURL:                    String
    public let appId:                   String
    public let attHandling:                ACKATTHandling
    public let attDelay:                   TimeInterval
    public let appsFlyerSignal:            ACKAppsFlyerSignal?
    public let appsFlyerIDProvider:        ACKAppsFlyerIDProvider?
    public let extraInstallFieldsProvider: ACKExtraInstallFieldsProvider?
    public let pushEnabled:                Bool
    public let fallbackURL:                String?
    public let splashProvider:             ACKSplashProvider?
    public let debugMode:                  ACKDebugMode
    ...
    public init(
        splash:              @escaping ACKSplashProvider,
        debugMode:           ACKDebugMode               = .disabled,
        attHandling:         ACKATTHandling              = .skip,
    ...
    public init(
        ...
        extraInstallFieldsProvider: ACKExtraInstallFieldsProvider? = nil
    ) {
    ...
    public init(
        ...
        syncURL:                    String,
        appId:                      String,
        attSignal:                  ACKATTSignal,
        attDelay:                   TimeInterval,
        appsFlyerSignal:            ACKAppsFlyerSignal?             = nil,
        appsFlyerIDProvider:        @escaping ACKAppsFlyerIDProvider,
        splash:                     ACKSplashProvider?              = nil,
        debugMode:                  ACKDebugMode                   = .disabled,
        pushEnabled:                Bool                           = true,
        fallbackURL:                String?                        = nil,
